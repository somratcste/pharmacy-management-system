      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h5 class="modal-title">Daliy Product</h5>
              </div>

              <div class="modal-body">
                  <!-- The form is placed inside the body of modal -->      
            <div class="box-header with-border">
              <h3 class="box-title">Daily Entry / Delivary Product</h3>
            </div><!-- /.box-header -->
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h5 class="modal-title">Monthly Product</h5>
              </div>

              <div class="modal-body">
                  <!-- The form is placed inside the body of modal -->      
            <div class="box-header with-border">
              <h3 class="box-title">Monthly Entry / Delivary Product</h3>
            </div><!-- /.box-header -->
