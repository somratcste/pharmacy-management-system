...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Compnay </span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
          <li><a href="company.php"><i class="fa fa-circle-o"></i>Company Section</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Product</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
      ...
      <li class="treeview">
        <a href="">
          <i class="fa fa-gg"></i> <span>Entry OR Delivary</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
      ...
      <!-- <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Member</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-gg"></i> <span>Password Change</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
      ...
      <!-- <li class="treeview">
        <a href="#">
          <i class="fa fa-share"></i> <span>Category Section</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
